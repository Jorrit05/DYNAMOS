...
var file_rabbitMQ_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x32, 0xef, 0x02, 0x0a,
...
var file_rabbitMQ_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_rabbitMQ_proto_goTypes = []interface{}{
	...
	nil,                         // 10: proto.ValidationResponse.ValidDataprovidersEntry
	nil,                         // 11: proto.AcceptedDataRequest.AuthorizedProvidersEntry
	(*anypb.Any)(nil),           // 12: google.protobuf.Any
	(*emptypb.Empty)(nil),       // 13: google.protobuf.Empty
}
var file_rabbitMQ_proto_depIdxs = []int32{
	12, // 0: proto.RabbitMQMessage.body:type_name -> google.protobuf.Any
	10, // 1: proto.ValidationResponse.valid_dataproviders:type_name -> proto.ValidationResponse.ValidDataprovidersEntry
	...
	11, // 7: proto.AcceptedDataRequest.authorized_providers:type_name -> proto.AcceptedDataRequest.AuthorizedProvidersEntry
	6,  // 8: proto.CompositionRequest.user:type_name -> proto.User
	4,  // 9: proto.ValidationResponse.ValidDataprovidersEntry.value:type_name -> proto.DataProvider
	0,  // 10: proto.SideCar.InitRabbitMq:input_type -> proto.ServiceRequest
	1,  // 11: proto.SideCar.Consume:input_type -> proto.ConsumeRequest
	7,  // 12: proto.SideCar.SendRequestApproval:input_type -> proto.RequestApproval
	5,  // 13: proto.SideCar.SendValidationResponse:input_type -> proto.ValidationResponse
	9,  // 14: proto.SideCar.SendCompositionRequest:input_type -> proto.CompositionRequest
	13, // 15: proto.SideCar.InitRabbitMq:output_type -> google.protobuf.Empty
	2,  // 16: proto.SideCar.Consume:output_type -> proto.RabbitMQMessage
	13, // 17: proto.SideCar.SendRequestApproval:output_type -> google.protobuf.Empty
	13, // 18: proto.SideCar.SendValidationResponse:output_type -> google.protobuf.Empty
	13, // 19: proto.SideCar.SendCompositionRequest:output_type -> google.protobuf.Empty
