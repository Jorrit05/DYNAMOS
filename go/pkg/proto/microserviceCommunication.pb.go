...
type MicroserviceCommunication struct {
	...
	OriginalRequest *any.Any          `protobuf:"bytes,5,opt,name=original_request,json=originalRequest,proto3" json:"original_request,omitempty"`
...
func (x *MicroserviceCommunication) GetOriginalRequest() *any.Any {
	if x != nil {
