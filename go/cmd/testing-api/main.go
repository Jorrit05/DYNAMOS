...
func main() {
	...
	apiMux.Handle("/test/orchestrator", &ochttp.Handler{Handler: orchestratorHandler()})
	apiMux.Handle("/test/policy-enforcer", &ochttp.Handler{Handler: policyEnforcerHandler()})
	apiMux.Handle("/test/api-gateway", &ochttp.Handler{Handler: apiGatewayHandler()})
