...
**This is an explanation of the aforementioned install script. Do not need to run the commands if the script was successful.**
...
**Important**: Remember to source your shell file after inserting the above into it.
```bash
source ~/.bashrc
```
or
